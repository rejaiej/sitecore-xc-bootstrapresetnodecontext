...
using CommerceProxy.Sitecore.Commerce.Core;
using CommerceProxy.Sitecore.Commerce.Core.Commands;
using CommerceProxy.Sitecore.Commerce.Engine;
using CommerceProxy.Sitecore.Commerce.EntityViews;
...
namespace Sitecore.Commerce.ServiceProxy
{
    ...
    public class Proxy
    {
        ...
        /// <param name="query">The query.</param>
        /// <returns>A value</returns>
        public static CommerceProxy.CommerceOps.Sitecore.Commerce.Core.Commands.CommerceCommand DoOpsCommand<T>(DataServiceActionQuerySingle<T> query)
        {
            try
            {
                var response = query.GetValueAsync().Result;
                var commandResponse = response as CommerceProxy.CommerceOps.Sitecore.Commerce.Core.Commands.CommerceCommand;
                if (commandResponse == null)
                {
                    return null;
                }
        ...
        /// <returns>A <see cref="CommerceProxy.Sitecore.Commerce.EntityViews.EntityView"/></returns>
